      ...
      <section id='skills' className='py-24 px-6 max-w-6xl mx-auto'>
          <div className='space-y-4 text-center md:text-left mb-16'>
              ...
              <p className='text-muted-foreground'>
                  {language === 'en'
                      ? sections.subtitle.en
                      : sections.subtitle.nl}
              </p>
          </div>
              ...
              <div className='space-y-8 p-10 rounded-3xl bg-primary/5 border border-primary/10 shadow-lg relative overflow-hidden group'>
                  ...
                  <div className='flex flex-wrap gap-3'>
                      {[
                          ...
                          <span
                              key={skill}
                              className='px-5 py-2.5 rounded-xl bg-background border border-border text-xs font-black uppercase tracking-widest text-foreground shadow-sm'
                          >
                              {skill}
                          </span>
                      ))}
